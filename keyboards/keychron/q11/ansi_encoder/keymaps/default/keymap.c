            ...
            switch (get_highest_layer(layer_state | default_layer_state)) {
                ...
                case LAYER_6:
                    if (is_keyboard_left()) {
                        ...
                        // windowed keycap setting
                        rgb_matrix_set_color_all(0,0,0);
                        rgb_matrix_set_color(23, 126,200,60);
                        rgb_matrix_set_color(0,  126,200,60);
                    }else{
                        // right
                        //rgb_matrix_set_color_all(255,255,0);
                        // windowed keycap setting
                        rgb_matrix_set_color_all(0,0,0);
                        rgb_matrix_set_color(49, 126,200,60);
                    }
                    break;
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_1] = LAYOUT_ansi_91(
        ...
        KC_LGUI,    MO(_FN1),   KC_LALT,      MO(_FN4),   KC_LGUI,              KC_SPC,                        MO(_FN1),           MO(_FN4), QK_LEAD,   MO(_FN2), KC_LEFT,   KC_DOWN,    KC_RGHT),
    ...
    [LAYER_2] = LAYOUT_ansi_91(
        ...
        G(KC_N),    MO(_FN1),   QK_LEAD,  TD(TD_XZ),        KC_WH_U,     TD(TD_BEA), KC_ESC,    KC_F,       KC_J,    KC_K,     KC_L,     KC_SCLN,  KC_QUOT,           KC_PENT,              KC_TRNS,
        MO(LAYER_1),KC_LSFT,              MO(_FN4),         TD(TD_F1112),TD(TD_SLH), TD(TD_VU), KC_LCTL,    KC_F15,  KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,           KC_RSFT,   KC_UP,
        MO(_FN1),   MO(_FN2),   KC_LALT,  KC_LCTL, MT(MOD_LGUI,KC_L),                KC_SPC,                         MO(_FN1),           KC_TRNS,  KC_TRNS, KC_TRNS,  KC_LEFT,   KC_DOWN,    KC_RGHT),
    ...
    [LAYER_3] = LAYOUT_ansi_91(
        ...
        KC_TRNS,    MO(_FN3), MT(MOD_LALT,KC_N),MO(_FN4),MT(MOD_LGUI,KC_L),           KC_GRV,                        MO(_FN1),           KC_TRNS,  KC_TRNS, KC_TRNS,  KC_LEFT,   KC_DOWN,    KC_RGHT),
    ...
    [LAYER_5] = LAYOUT_ansi_91(
        KC_MUTE,  KC_TRNS,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,     KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,     KC_F12,   KC_F13,   KC_TRNS,  TG(LAYER_6),
        ...
        KC_TRNS,  MO(_FN1), KC_LALT,  KC_LGUI,  MO(_FN4),         KC_SPC,                        KC_RSFT,              KC_TRNS,  MO(_FN1),   KC_TRNS,  KC_LEFT,  KC_DOWN,  KC_RGHT),

    [LAYER_6] = LAYOUT_ansi_91(
        KC_MUTE,  KC_TRNS,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,     KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,     KC_F12,   KC_F13,   KC_TRNS,  TO(LAYER_1),
        KC_TRNS,  KC_ESC,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,      KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,    KC_EQL,   KC_BSPC,            KC_TRNS,
        KC_TRNS,  KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,      KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,    KC_RBRC,  KC_BSLS,            KC_TRNS,
        KC_TRNS,  KC_LGUI,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,      KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,              KC_ENT,             KC_TRNS,
        KC_TRNS,  KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,              KC_RSFT,  KC_UP,
        KC_TRNS,  KC_LCTL,  KC_LALT,  MO(_FN1), MO(_FN4),         KC_SPC,                        KC_RSFT,              KC_TRNS,  MO(_FN1),   KC_TRNS,  KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [_FN1] = LAYOUT_ansi_91(
        ...
        XXXXXXX,  XXXXXXX,                G(KC_Z),   G(KC_X),  G(KC_C),  G(KC_V),   XXXXXXX,    KC_END,    KC_PGDN,  KC_PGUP,  KC_HOME,  XXXXXXX,              XXXXXXX,  XXXXXXX,
        XXXXXXX,  XXXXXXX,    XXXXXXX,    G(KC_MINS),G(KC_EQL),          KC_BSPC,                          XXXXXXX,            XXXXXXX,  XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX),
    ...
    [_FN2] = LAYOUT_ansi_91(
        ...
        XXXXXXX,  KC_PENT,    XXXXXXX,   XXXXXXX,   KC_WH_D,   G(KC_Z),   G(KC_N),   KC_MPRV,  KC_VOLD,  KC_VOLU,  KC_MNXT,  XXXXXXX,  XXXXXXX,              XXXXXXX,            XXXXXXX,
        XXXXXXX,  XXXXXXX,               XXXXXXX,   XXXXXXX,   SGUI(KC_Z),KC_F8,     XXXXXXX,  KC_MUTE,  KC_MPLY,  XXXXXXX,  XXXXXXX,  XXXXXXX,              XXXXXXX,  XXXXXXX,
    ...
    [_FN4] = LAYOUT_ansi_91(
        ...
        XXXXXXX,    XXXXXXX,    KC_F13,     KC_F14,     KC_F15,   KC_F16,   KC_P6,     G(C(KC_Q)),LAG(KC_GRV),XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,    XXXXXXX,  SGUI(KC_4),         XXXXXXX,
        XXXXXXX,    KC_LCTL,    KC_P1,      KC_P2,      KC_P3,    KC_P4,    KC_P5,     KC_LEFT,   KC_DOWN,    KC_UP,    KC_RGHT,  XXXXXXX,  XXXXXXX,              XXXXXXX,            XXXXXXX,
        XXXXXXX,    KC_LSFT,                XXXXXXX,    KC_P7,    KC_P8,    KC_P9,     KC_P0,     KC_END,     KC_PGDN,  KC_PGUP,  KC_HOME,  XXXXXXX,              XXXXXXX,            XXXXXXX,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [LAYER_6] = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU),        ENCODER_CCW_CW(KC_WH_D, KC_WH_U) },
