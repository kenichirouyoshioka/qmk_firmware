...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LBRC,    KC_RBRC,       KC_F9,      TD(TD_F1112), KC_ESC,    KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,       KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_MUTE,
    ...
    [LAYER_2] = LAYOUT_105_ansi(
        ...
        KC_P1,    KC_P2,    KC_P3,  KC_PENT,   SFT_T(KC_SLSH),         KC_F9,     TD(TD_F1112),   TD(TD_KOH),  TD(TD_VF8),  TD(TD_02),  TO(LAYER_1),KC_N,   KC_M, KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT, KC_UP,
 ...
 */
    ...
    [_FN2] = LAYOUT_105_ansi(
        XXXXXXX,  XXXXXXX,   XXXXXXX,     XXXXXXX,   XXXXXXX,    XXXXXXX,  XXXXXXX,   XXXXXXX,    XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
        KC_F6,    KC_F7,     KC_F8,       XXXXXXX,   XXXXXXX,    XXXXXXX,  XXXXXXX,   XXXXXXX,    XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
        XXXXXXX,  G(KC_G),   G(KC_COMM),  KC_BSPC,   TO(LAYER_1),XXXXXXX,  G(C(KC_F)),SGUI(KC_I), KC_F15,    KC_F16,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
        XXXXXXX,  KC_WH_D,   SGUI(KC_Z),             KC_PENT,    XXXXXXX,  KC_F7,     KC_WH_D,    G(KC_Z),   KC_F13,             XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
        XXXXXXX,  XXXXXXX,   G(KC_J),     KC_PENT,   XXXXXXX,              XXXXXXX,   XXXXXXX,    G(KC_0),   G(KC_1),  KC_F14,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
        XXXXXXX,             G(KC_D),                XXXXXXX,    XXXXXXX,             XXXXXXX,               KC_F,     XXXXXXX,            XXXXXXX,            XXXXXXX,  XXXXXXX,            XXXXXXX,  XXXXXXX,  XXXXXXX),
    ...
    [_FN4] = LAYOUT_105_ansi(
        ...
        XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,  G(C(KC_Q)),LAG(KC_GRV),XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
        XXXXXXX,  XXXXXXX,  XXXXXXX,               XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,             XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
