...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_1] = LAYOUT_ansi_91(
        TG(LAYER_5),G(C(KC_Q)), KC_F1,         KC_F2,      KC_F3,      KC_F4,    KC_F5,     KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,    KC_F12,   KC_F13,    KC_F14,     TG(LAYER_5),
    ...
    [LAYER_5] = LAYOUT_ansi_91(
        ...
        KC_TRNS,    KC_TRNS, KC_TRNS,   KC_TRNS,  KC_TRNS,            KC_BSPC,                       KC_SPC,             KC_TRNS,  KC_TRNS,    KC_TRNS,  KC_LEFT,  KC_DOWN,  KC_RGHT),
