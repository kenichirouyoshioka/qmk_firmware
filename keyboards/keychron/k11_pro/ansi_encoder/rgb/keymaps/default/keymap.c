...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    TD(TD_TAB2), KC_Q,     KC_W,     KC_E,    KC_R,    KC_T,    KC_Y,      KC_U,        KC_I,    KC_O,    KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,          MO(_BT),
    ...
    [LAYER_2] = LAYOUT_69_ansi(
        KC_TRNS,         KC_P1,     C(KC_WH_D), C(KC_WH_U),  TD(TD_P45), TD(TD_P67), TD(TD_P89),KC_7,       KC_8,    KC_9,    KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,          MO(_FN1),
        TD(TD_TAB1),     KC_LBRC,   KC_RBRC,    ALT_T(KC_F1),CTL_T(KC_R),TD(TD_1F10),KC_Y,      KC_U,       KC_I,    KC_O,    KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,          KC_TRNS,
        MO(_FN1),        QK_LEAD,   TD(TD_XMG), KC_WH_U,     TD(TD_BEA), KC_ESC,                KC_H,       KC_J,    KC_K,    KC_L,     KC_SCLN,  KC_QUOT,  KC_PENT,          XXXXXXX,
        SFT_T(KC_SLSH),             KC_F9,      TD(TD_F1112),TD(TD_KOH), TD(TD_VF8), TD(TD_02), TO(LAYER_1),KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT, KC_UP,
        MO(_FN2),ALT_T(KC_Z),       MT(MOD_LGUI,KC_L),       KC_SPC,     MO(_FN4),              KC_TRNS,             KC_TRNS,           KC_TRNS,            KC_LEFT, KC_DOWN, KC_RGHT),
