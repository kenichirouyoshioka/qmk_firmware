...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_2] = LAYOUT_69_ansi(
        ...
        MO(_FN2),KC_LALT,MT(MOD_LGUI,KC_L),          KC_SPC,               MO(_FN4),   MO(_FN1),            KC_TRNS,           KC_LGUI,            KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [LAYER_3] = LAYOUT_69_ansi(
        ...
        MO(_FN3),MT(MOD_LALT,KC_N),MT(MOD_LGUI,KC_L),KC_GRV,            MO(_FN4),   KC_TRNS,             KC_TRNS,           QK_LEAD,            KC_LEFT,  KC_DOWN,KC_RGHT),
