...
MT(MOD_LSFT,KC_Y),KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,              KC_P8,   KC_TRNS,
...
[_FN2] = LAYOUT_ansi_68(
     ...
     XXXXXXX,  KC_F12,   G(C(KC_F)),SGUI(KC_I),G(KC_SLSH),KC_F2,   KC_F3,    KC_F4,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
