...
[LAYER_1] = LAYOUT_ansi_84(
             KC_GRV,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,     KC_F12,   TG(LAYER_2),TG(LAYER_5),MO(_BT),
             KC_ESC,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,    KC_EQL,   KC_BSPC,                TG(LAYER_4),
...
[LAYER_2] = LAYOUT_ansi_84(
   KC_GRV,     KC_F1,         KC_F2,      KC_F3,       KC_F4,       KC_F5,      KC_F6,     KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,     KC_F12,   TG(LAYER_3),KC_TRNS,MO(_BT),
   TO(LAYER_1),KC_F10,        KC_Z,       KC_P,        TD(TD_P45),  TD(TD_P67), TD(TD_P89),KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,    KC_EQL,   KC_BSPC,            TO(LAYER_1),
   ...
   SFT_T(KC_M),               KC_F9,      TD(TD_F1112),TD(TD_KOH),  TD(TD_VF8), TD(TD_02), KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,              KC_RSFT,  KC_UP,    KC_TRNS,
   MO(_FN2),   ALT_T(KC_SLSH),GUI_T(KC_L),                                      KC_SPC,                                  MO(_FN1), KC_RCTL,    KC_RGUI,  KC_LEFT,  KC_DOWN,  KC_RGHT),

[LAYER_3] = LAYOUT_ansi_84(
         KC_GRV,         KC_F1,     KC_F2,      KC_F3,    KC_F4,     KC_F5,    KC_F6,     KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,     KC_F12,   TG(LAYER_4), KC_TRNS,   MO(_BT),
         KC_ESC,         KC_1,      KC_2,       KC_3,     KC_4,      KC_5,     KC_6,      KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,    KC_EQL,   KC_BSPC,                TO(LAYER_1),
         KC_TAB,         KC_Q,      KC_W,       KC_E,     KC_R,      KC_T,     KC_Y,      KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,    KC_RBRC,  KC_BSLS,                KC_TRNS,
         CTL_T(KC_K),    KC_A,      KC_S,       KC_D,     TD(TD_GF), KC_G,     KC_H,      KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,              KC_ENT,                 KC_TRNS,
         SFT_T(KC_Y),               KC_Z,       KC_X,     KC_C,      KC_V,     KC_B,      KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,              KC_RSFT,     KC_UP,     KC_TRNS,
         MO(_FN3),     ALT_T(KC_N), GUI_T(KC_L),                               KC_GRV,                                  MO(_FN1), KC_RCTL,    KC_RGUI,  KC_LEFT,     KC_DOWN,   KC_RGHT),
[LAYER_4] = LAYOUT_ansi_84(//colemak
         KC_GRV,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,     KC_F12,   TG(LAYER_5),XXXXXXX,MO(_BT),
         KC_ESC,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,    KC_EQL,   KC_BSPC,            TO(LAYER_1),
         ...
         KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_K,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,              KC_RSFT,  KC_UP,    KC_TRNS,
         MO(_FN1), KC_LALT,  KC_LGUI,                                KC_SPC,                                 MO(_FN1), KC_RCTL,    KC_RGUI,  KC_LEFT,  KC_DOWN,  KC_RGHT),
[LAYER_5] = LAYOUT_ansi_84(//dvorak
         KC_GRV,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,     KC_F12,   TO(LAYER_1),TO(LAYER_1), MO(_BT),
         ...
         KC_LSFT,            KC_SCLN,  KC_Q,     KC_J,     KC_K,     KC_X,     KC_B,     KC_M,     KC_W,     KC_V,     KC_Z,                 KC_RSFT,    KC_UP,       KC_TRNS,
         MO(_FN1), KC_LALT,  KC_LGUI,                                KC_SPC,                                 MO(_FN1), KC_RCTL,    KC_RGUI,  KC_LEFT,    KC_DOWN,     KC_RGHT),
...
[_BT] = LAYOUT_ansi_84(
    ...
    [_FN1] = LAYOUT_ansi_84(
         ...
         TG(LAYER_2),  XXXXXXX,    G(KC_N),  G(KC_E),  G(KC_COMM),G(KC_T),  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,    XXXXXXX,  XXXXXXX,            XXXXXXX,
             ...
             XXXXXXX,              XXXXXXX,  XXXXXXX,  G(KC_J),   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,              XXXXXXX,  XXXXXXX,  XXXXXXX,
             XXXXXXX,  G(KC_MINS), G(KC_EQL),                               KC_BSPC,                                XXXXXXX,  XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX),
    [_FN2] = LAYOUT_ansi_84(
             XXXXXXX,  XXXXXXX,  XXXXXXX,    XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
             XXXXXXX,  XXXXXXX,  XXXXXXX,    XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,    XXXXXXX,  XXXXXXX,            XXXXXXX,
             SC,       XXXXXXX,  G(C(KC_F)), SGUI(KC_I),KC_F15,   KC_F16,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,    XXXXXXX,  XXXXXXX,            XXXXXXX,
             KC_PENT,  XXXXXXX,  KC_F7,      KC_WH_D,   G(KC_Z),  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,              XXXXXXX,            XXXXXXX,
             XXXXXXX,            XXXXXXX,    XXXXXXX,   KC_F13,   KC_F14,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,              XXXXXXX,  XXXXXXX,  XXXXXXX,
             XXXXXXX,  XXXXXXX,  XXXXXXX,                                   KC_F,                                   XXXXXXX,  XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX),
    [_FN3] = LAYOUT_ansi_84(
             XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
             ...
             KC_ENT,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,            XXXXXXX,
