...
[_FN2] = LAYOUT_ansi_87(
    ...
    XXXXXXX,  XXXXXXX,   G(C(KC_F)),SGUI(KC_I),XXXXXXX,   KC_F2,     KC_F3,   KC_F4,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX, XXXXXXX,  XXXXXXX,  XXXXXXX,
    ...
    XXXXXXX,  XXXXXXX,   G(KC_T),                                    KC_F12,                                XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX),
