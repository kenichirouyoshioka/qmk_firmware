...
[LAYER_2] = LAYOUT_ansi_69(
       ...
       MO(_FN2),KC_LALT,MT(MOD_LGUI,KC_L),          KC_SPC,               MO(_FN4),   MO(_FN4),            MO(_FN1),          QK_LEAD,            KC_LEFT, KC_DOWN, KC_RGHT),
...
[LAYER_3] = LAYOUT_ansi_69(
       ...
       MO(_FN3),MT(MOD_LALT,KC_N),MT(MOD_LGUI,KC_L),KC_GRV,            MO(_FN4),   MO(_FN4),            KC_TRNS,           QK_LEAD,            KC_LEFT,  KC_DOWN,KC_RGHT),
