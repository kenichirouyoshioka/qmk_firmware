...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_1] = LAYOUT_ansi_91(
        MO(_FN4),   KC_GRV,   KC_F1,         KC_F2,      KC_F3,      KC_F4,    KC_F5,     KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,    KC_F12,   KC_F13,    KC_F14,     TG(LAYER_5),
        ...
        KC_HOME,    KC_LCTL,  KC_A,          KC_S,       KC_D,       KC_F,     KC_G,      KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,             KC_ENT,                C(KC_UP),
        KC_END,     KC_LSFT,                 KC_Z,       KC_X,       KC_C,     KC_V,      KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,             KC_RSFT,   KC_UP,
        MO(_FN1),   MO(_FN1),  KC_LALT,      MO(_FN4),   KC_LGUI,              KC_SPC,                        MO(_FN1),           KC_RGUI,  QK_LEAD,   KC_RCTL,  KC_LEFT,   KC_DOWN,    KC_RGHT),
    
    [LAYER_2] = LAYOUT_ansi_91(
        MO(_FN2),   KC_COMM,    KC_DOT,   KC_F2,            KC_F3,       KC_F4,      KC_F5,     KC_F6,      KC_F7,   KC_F8,    KC_F9,    KC_F10,   KC_F11,  KC_F12,   KC_TRNS,   KC_TRNS,   MO(_FN1),
        G(KC_LBRC), G(KC_K),    KC_LSFT,  KC_LBRC,          KC_RBRC,     G(KC_Q),    G(KC_0),   G(KC_1),    KC_7,    KC_8,     KC_9,     KC_0,     KC_MINS, KC_EQL,   KC_BSPC,              MO(_FN1),
        G(KC_RBRC), KC_TAB,     G(KC_J),  TD(TD_MG),        ALT_T(KC_F1),KC_R,       TD(TD_KO), KC_F13,     KC_F14,  KC_I,     KC_O,     KC_P,     KC_LBRC, KC_RBRC,  KC_BSLS,              MO(_FN2),
        G(KC_N),    MO(_FN1),   QK_LEAD,  TD(TD_XZ),        KC_WH_U,     TD(TD_BEA), KC_ESC,    KC_F,       KC_J,    KC_K,     KC_L,     KC_SCLN,  KC_QUOT,           KC_PENT,              MO(_FN4),
        MO(_FN4),   KC_LSFT,              MO(_FN4),         TD(TD_F1112),TD(TD_SLH), TD(TD_VU), KC_LCTL,    KC_F15,  KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,           KC_RSFT,   KC_UP,
        MO(_FN1),   MO(_FN2),   KC_LALT,  KC_LCTL, MT(MOD_LGUI,KC_L),                KC_SPC,                         MO(_FN1),           KC_RGUI,  QK_LEAD, KC_RCTL,  KC_LEFT,   KC_DOWN,    KC_RGHT),

    [LAYER_3] = LAYOUT_ansi_91(
        MO(_FN1),   KC_P0,            KC_F1,            KC_F2,    KC_F3,    KC_F4,    KC_F5,     KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,  KC_F12,   KC_TRNS,   KC_TRNS,  MO(_FN1),
        KC_HOME,    KC_ESC,           KC_1,             KC_2,     KC_3,     KC_4,     KC_5,      KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS, KC_EQL,   KC_BSPC,             MO(_FN1),
        KC_PDOT,    KC_TAB,           KC_Q,             KC_W,     KC_E,     KC_R,     KC_T,      KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC, KC_RBRC,  KC_BSLS,             MO(_FN3),
        G(KC_I),    MT(MOD_LCTL,KC_K),KC_A,             KC_S,     KC_D,     TD(TD_GF),KC_G,      KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,           KC_ENT,              MO(_FN4),
        MO(_FN4),   MT(MOD_LSFT,KC_Y),                  KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,           KC_RSFT,   KC_UP,
        KC_TRNS,    MO(_FN3), MT(MOD_LALT,KC_N),MO(_FN4),MT(MOD_LGUI,KC_L),           KC_GRV,                        MO(_FN1),           KC_RGUI,  QK_LEAD, KC_RCTL,  KC_LEFT,   KC_DOWN,    KC_RGHT),
    ...
    [LAYER_5] = LAYOUT_ansi_91(
        KC_MUTE,  KC_GRV,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,     KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,     KC_F12,   KC_F13,   KC_TRNS,  TO(LAYER_1),
        KC_TRNS,  KC_ESC,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,      KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_LBRC,    KC_RBRC,  KC_BSPC,            KC_TRNS,
        KC_TRNS,  KC_TAB,   KC_QUOT,  KC_COMM,  KC_DOT,   KC_P,     KC_Y,      KC_F,     KC_G,     KC_C,     KC_R,     KC_L,     KC_SLSH,    KC_EQL,   KC_BSLS,            KC_TRNS,
        ...
        KC_TRNS,  MO(_FN1), KC_LALT,  KC_LGUI,  MO(_FN5),         KC_SPC,                        KC_RSFT,              KC_RGUI,  QK_LEAD,    KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
    
    
    [_FN1] = LAYOUT_ansi_91(
        XXXXXXX,  KC_TILD,    XXXXXXX,    XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,    XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
        ...
        XXXXXXX,  XXXXXXX,                G(KC_Z),   G(KC_X),  G(KC_C),  G(KC_V),   XXXXXXX,    KC_END,    KC_PGDN,  KC_PGUP,  KC_HOME,  XXXXXXX,              KC_MPLY,  KC_VOLU,
        XXXXXXX,  XXXXXXX,    XXXXXXX,    G(KC_MINS),G(KC_EQL),          KC_BSPC,                          XXXXXXX,            KC_MUTE,  XXXXXXX,    XXXXXXX,  KC_MPRV,  KC_VOLD,  KC_MNXT),
    ...
    [_FN3] = LAYOUT_ansi_91(
        ...
        A(KC_H),  KC_H,                 XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,              XXXXXXX,  KC_P8,
        XXXXXXX,  XXXXXXX,  XXXXXXX,    XXXXXXX,  XXXXXXX,            XXXXXXX,                       XXXXXXX,            XXXXXXX,  XXXXXXX,    KC_RCTL,  KC_P4,    KC_P2,    KC_P6),
    
    [_FN4] = LAYOUT_ansi_91(
        XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,   XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
        XXXXXXX,    XXXXXXX,    KC_F7,      KC_F8,      KC_F9,    KC_F10,   KC_F11,    KC_F12,    XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,    XXXXXXX,  XXXXXXX,            XXXXXXX,
        XXXXXXX,    XXXXXXX,    KC_F13,     KC_F14,     KC_F15,   KC_F16,   KC_P6,     G(C(KC_Q)),XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,    XXXXXXX,  KC_ESC,             XXXXXXX,
        XXXXXXX,    KC_LCTL,    KC_P1,      KC_P2,      KC_P3,    KC_P4,    KC_P5,     XXXXXXX,   XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,              XXXXXXX,            XXXXXXX,
        XXXXXXX,    KC_LSFT,                XXXXXXX,    KC_P7,    KC_P8,    KC_P9,     KC_P0,     LAG(KC_GRV),XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,              XXXXXXX,  XXXXXXX,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [LAYER_5] = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU),        ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
