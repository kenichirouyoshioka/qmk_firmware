...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_1] = LAYOUT_ansi_69(
        ...
        MO(_FN1),   KC_LALT,  KC_LGUI,           KC_SPC,           TG(LAYER_2),MO(_FN4),             KC_RSFT,           KC_RGUI,            KC_LEFT, KC_DOWN, KC_RGHT),
 ...
 [LAYER_2] = LAYOUT_ansi_69(
   ...
   MO(_FN2),   ALT_T(KC_SLSH),GUI_T(KC_L),             KC_SPC,                 TO(LAYER_1),KC_TRNS,             KC_TRNS,           KC_TRNS,            KC_LEFT, KC_DOWN, KC_RGHT),

    [LAYER_3] = LAYOUT_ansi_69(
        KC_ESC,             KC_P1,KC_P2,    KC_P3,   KC_P4,    KC_P5,   KC_P6,      KC_P7,      KC_P8,   KC_P9,   KC_P0,    KC_MINS,  KC_EQL,   KC_BSPC,          KC_TRNS,
