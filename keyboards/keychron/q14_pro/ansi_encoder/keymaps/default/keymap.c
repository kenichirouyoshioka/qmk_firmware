...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    MO(_FN2),   KC_F13,           KC_F14,     KC_F15,       G(C(KC_Q)),KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,      KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   MO(_BT),            XXXXXXX,
    KC_LBRC,    KC_RBRC,          KC_F8,      C(KC_WH_U),   KC_ESC,    KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,       KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_MUTE,
    KC_ESC,     ALT_T(KC_F1),     SFT_T(KC_V),C(KC_WH_D),   KC_TAB,    KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,       KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,            KC_VOLU,
    QK_LEAD,    KC_WH_U,          CTL_T(KC_R),              KC_LCTL,   KC_A,     KC_S,     KC_D,     KC_F,     KC_G,               KC_H,       KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_ENT,             KC_VOLD,
    MO(_FN2),   GUI_T(KC_L),      TD(TD_BEA), KC_SPC,       KC_LSFT,             KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     TG(LAYER_2),KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,
    KC_P0,                        KC_X,                     MO(_FN1),  KC_LALT,            KC_LGUI,            KC_SPC,   MO(_FN4),             KC_RSFT,            MO(_FN1), KC_RGUI,            KC_LEFT,  KC_DOWN,  KC_RGHT),
    
    [LAYER_2] = LAYOUT_105_ansi(
        MO(_FN2), KC_F13,   KC_F14,   KC_F15,       KC_TRNS,      KC_COMM,      KC_DOT,    KC_F3,          KC_F4,       KC_F5,     KC_F6,      KC_F7,      KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_TRNS,            KC_TRNS,
        KC_NUM,   KC_PSLS,  KC_PAST,  C(KC_WH_U),   KC_ESC,       KC_P1,        C(KC_WH_D),C(KC_WH_U),     KC_P4,       KC_P5,     KC_P6,      KC_7,       KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_TRNS,
        KC_P7,    KC_P8,    KC_P9,    C(KC_WH_D),   KC_TAB,       KC_LBRC,      KC_RBRC,   ALT_T(KC_F1),   CTL_T(KC_R), KC_F8,     C(KC_WH_U), KC_F13,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,            KC_TRNS,
        KC_P4,    KC_P5,    KC_P6,                  MO(_FN1),     QK_LEAD,      TD(TD_XZ), KC_WH_U,        TD(TD_BEA),  KC_ESC,                C(KC_WH_D), KC_F14,   KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_ENT,             KC_TRNS,
        KC_P1,    KC_P2,    KC_P3,    TO(LAYER_1),  SFT_T(KC_V),                MO(_FN4),  TD(TD_F1112),   TD(TD_SLH),  KC_M,      KC_P0,      TO(LAYER_1),KC_F,     KC_F15,   KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,
        KC_P0,              KC_PDOT,                MO(_FN2),ALT_T(KC_G),      GUI_T(KC_L),                KC_SPC,      MO(_FN4),                          KC_TRNS,            KC_TRNS,  KC_TRNS,            KC_LEFT,  KC_DOWN,  KC_RGHT),

    [LAYER_3] = LAYOUT_105_ansi(
        MO(_FN3), XXXXXXX,  C(KC_WH_U),C(KC_WH_D),   KC_TRNS,      KC_F1,     KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_TRNS,            KC_TRNS,
        ...
        KC_P1,    KC_P2,    KC_P3,     KC_PENT,  MT(MOD_LSFT,KC_Y),           KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     QK_LEAD,  KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,
...
/*colemak
    [LAYER_5] = LAYOUT_105_ansi(
        ...
        KC_P7,       KC_P8,    KC_P9,    KC_PPLS,   KC_TAB,   KC_Q,     KC_W,     KC_F,     KC_P,     KC_G,     KC_J,     KC_L,     KC_U,     KC_Y,     KC_SCLN,  KC_LBRC,  KC_RBRC,  KC_BSLS,            KC_TRNS,
        KC_P4,       KC_P5,    KC_P6,               KC_LCTL,  KC_A,     KC_R,     KC_S,     KC_T,     KC_D,               KC_H,     KC_N,     KC_E,     KC_I,     KC_O,     KC_QUOT,  KC_ENT,             KC_TRNS,
        KC_P1,       KC_P2,    KC_P3,    KC_PENT,   KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     QK_LEAD,  KC_K,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,
        KC_P0,                 KC_PDOT,             MO(_FN1), KC_TRNS,            KC_LGUI,            KC_SPC,   MO(_FN1),           KC_RSFT,            KC_TRNS,  KC_TRNS,            KC_LEFT,  KC_DOWN,  KC_RGHT),
 */
    ...
    [_FN1] = LAYOUT_105_ansi(
        XXXXXXX,   XXXXXXX,     XXXXXXX,   XXXXXXX,   XXXXXXX,    XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
        XXXXXXX,   KC_SLSH,     XXXXXXX,   XXXXXXX,   KC_TILD,    KC_F1,      KC_F2,    KC_F3,    KC_F4,     KC_F5,     KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   XXXXXXX,            XXXXXXX,
        XXXXXXX,   G(KC_N),     G(KC_T),   XXXXXXX,   TG(LAYER_2),TG(LAYER_3),G(KC_W),  G(KC_E),  G(KC_R),   G(KC_T),   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  SGUI(KC_4),         XXXXXXX,
        XXXXXXX,   KC_WH_D,     G(KC_E),              XXXXXXX,    G(KC_K),    G(KC_S),  G(KC_D),  SGUI(KC_Z),G(KC_G),             KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
        XXXXXXX,   G(KC_D),     G(KC_Z),   XXXXXXX,   XXXXXXX,                G(KC_Z),  G(KC_J),  G(KC_N),   G(KC_COMM),XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_VOLU,
        XXXXXXX,                G(KC_J),              XXXXXXX,    G(KC_MINS),           G(KC_EQL),           KC_BSPC,   XXXXXXX,            XXXXXXX,            XXXXXXX,  XXXXXXX,            KC_MUTE,  KC_VOLD, KC_MPLY),
    ...
    [_FN2] = LAYOUT_105_ansi(
        ...
        XXXXXXX,  XXXXXXX,   XXXXXXX,     XXXXXXX,   XXXXXXX,    XXXXXXX,  G(KC_LBRC),G(KC_RBRC), XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
        XXXXXXX,  G(KC_G),   TD(TD_F1112),XXXXXXX,   TO(LAYER_1),G(KC_K),  G(C(KC_F)),SGUI(KC_I), G(KC_COMM),XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
        XXXXXXX,  KC_BSPC,   G(KC_COMM),             KC_PENT,    XXXXXXX,  G(KC_1),   KC_WH_D,    G(KC_Z),   XXXXXXX,            XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
        XXXXXXX,  G(KC_S),   SGUI(KC_Z),  KC_PENT,   XXXXXXX,              XXXXXXX,   XXXXXXX,    KC_P,      XXXXXXX,  G(KC_0),  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
        XXXXXXX,             G(KC_K),                XXXXXXX,    XXXXXXX,             XXXXXXX,               XXXXXXX,  XXXXXXX,            XXXXXXX,            XXXXXXX,  XXXXXXX,            XXXXXXX,  XXXXXXX,  XXXXXXX),
    
    [_FN3] = LAYOUT_105_ansi(
        XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,     XXXXXXX,  XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
        XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,     KC_P,     XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
        XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,     KC_M,     TO(LAYER_1),XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
        XXXXXXX,  XXXXXXX,  XXXXXXX,               KC_PENT,  XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
        XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,     KC_H,                 XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    ...
    [_FN4] = LAYOUT_105_ansi(
        XXXXXXX,   XXXXXXX,     XXXXXXX,   XXXXXXX,     XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,  XXXXXXX,   XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
        XXXXXXX,   XXXXXXX,     XXXXXXX,   XXXXXXX,     KC_GRV,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,  XXXXXXX,   XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
        XXXXXXX,   XXXXXXX,     XXXXXXX,   XXXXXXX,     XXXXXXX,  KC_F13,   KC_F14,   KC_F15,   KC_F16,    KC_F10,   G(C(KC_Q)),LAG(KC_GRV),XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
        XXXXXXX,   XXXXXXX,     XXXXXXX,                XXXXXXX,  XXXXXXX,  KC_F12,   KC_WH_D,  SGUI(KC_Z),KC_F11,              XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
        XXXXXXX,   XXXXXXX,     XXXXXXX,   XXXXXXX,     XXXXXXX,            XXXXXXX,  XXXXXXX,  KC_F9,     KC_F8,    KC_F7,     XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
        XXXXXXX,                XXXXXXX,                XXXXXXX,  XXXXXXX,            XXXXXXX,             XXXXXXX,  XXXXXXX,               XXXXXXX,            XXXXXXX,  XXXXXXX,            XXXXXXX,  XXXXXXX,  XXXXXXX),
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [LAYER_1] = { ENCODER_CCW_CW(C(KC_WH_U), C(KC_WH_D)) },
    [LAYER_2] = { ENCODER_CCW_CW(C(KC_WH_U), C(KC_WH_D)) },
    [LAYER_3] = { ENCODER_CCW_CW(C(KC_WH_U), C(KC_WH_D)) },
