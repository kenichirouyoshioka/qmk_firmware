...
[LAYER_1] = LAYOUT_ansi_89(
    MO(_FN4),   G(C(KC_Q)), KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,     KC_F6,   KC_F7,      KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_F13,             KC_MUTE,
    KC_MPRV,    KC_ESC,     KC_1,     KC_2,     KC_3,     KC_4,     KC_5,      KC_6,    KC_7,       KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_VOLU,
    KC_MNXT,    KC_TAB,     KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,      KC_Y,    KC_U,       KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,            KC_VOLD,
    KC_MPLY,    KC_LCTL,    KC_A,     KC_S,     KC_D,     KC_F,     KC_G,      KC_H,    KC_J,       KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,             TG(LAYER_5),
    QK_LEAD,    KC_LSFT,              KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,    KC_BSPC,    KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,
    KC_LGUI,    MO(_FN1),   KC_LALT,            KC_LGUI,  KC_SPC,   MO(_FN4),                       MO(_FN1),           MO(_FN2),                     KC_LEFT,  KC_DOWN,  KC_RGHT),
...
[LAYER_2] = LAYOUT_ansi_89(
    ...
    MO(LAYER_1),KC_LSFT,               MO(_FN4),   TD(TD_F1112),TD(TD_SLH), TD(TD_VU),  KC_LCTL,    KC_F15,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,
    KC_TRNS,    MO(_FN2),   KC_LALT,   MT(MOD_LGUI,KC_L),       KC_SPC,     MO(_FN4),                           MO(_FN1),           KC_TRNS,                      KC_LEFT,  KC_DOWN,  KC_RGHT),
...
[LAYER_3] = LAYOUT_ansi_89(
    ...
    A(KC_H),    MT(MOD_LSFT,KC_Y),            KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,     KC_SPC,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,
    MO(_FN1),   MO(_FN3),MT(MOD_LALT,KC_N),MT(MOD_LGUI,KC_L),     KC_GRV,   MO(_FN4),                        MO(_FN1),           KC_TRNS,                      KC_LEFT,  KC_DOWN,  KC_RGHT),
...
[LAYER_5] = LAYOUT_ansi_89(
        ...
        KC_TRNS,    KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,     KC_BSPC,  KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,
        KC_TRNS,    MO(_FN1), KC_LALT,            KC_LGUI,  KC_SPC,  MO(_FN4),                       KC_RSFT,            KC_TRNS,                      KC_LEFT,  KC_DOWN,  KC_RGHT),

[LAYER_6] = LAYOUT_ansi_89(
        KC_TRNS,    KC_TRNS,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,     KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_F13,             KC_TRNS,
        KC_TRNS,    KC_ESC,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,      KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_TRNS,
        KC_TRNS,    KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,      KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,            KC_TRNS,
        KC_TRNS,    KC_LGUI,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,      KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,             TO(LAYER_1),
        KC_TRNS,    KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,     KC_BSPC,  KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,
        KC_TRNS,    KC_LCTL,  KC_LALT,            MO(_FN1), KC_SPC,  MO(_FN4),                       KC_RSFT,            KC_TRNS,                      KC_LEFT,  KC_DOWN,  KC_RGHT),
...
[_FN1] = LAYOUT_ansi_89(
    ...
    XXXXXXX,  TG(LAYER_2),TG(LAYER_3),XXXXXXX,   G(KC_E),  G(KC_R),  G(KC_T),   XXXXXXX,    XXXXXXX,   XXXXXXX,  XXXXXXX,  G(KC_P),   XXXXXXX,  XXXXXXX,   XXXXXXX,           XXXXXXX,
    XXXXXXX,  XXXXXXX,    XXXXXXX,    G(KC_S),   G(KC_D),  G(KC_F),  G(KC_G),   KC_LEFT,    KC_DOWN,   KC_UP,    KC_RGHT,  KC_TILD,   KC_GRV,              KC_PENT,           XXXXXXX,
    XXXXXXX,  XXXXXXX,                G(KC_Z),   G(KC_X),  G(KC_C),  G(KC_V),   XXXXXXX,    XXXXXXX,   KC_END,   KC_PGDN,  KC_PGUP,   KC_HOME,  XXXXXXX,   XXXXXXX,  XXXXXXX,
    XXXXXXX,  XXXXXXX,    G(KC_MINS),            G(KC_EQL),KC_BSPC,  XXXXXXX,                          XXXXXXX,            XXXXXXX,                        XXXXXXX,  XXXXXXX, XXXXXXX),
...
[_FN2] = LAYOUT_ansi_89(
    ...
    XXXXXXX,  KC_PENT,    XXXXXXX,  XXXXXXX,    KC_WH_D,   G(KC_Z),   G(KC_N),   KC_MPRV,  KC_VOLD,  KC_VOLU,  KC_MNXT,  XXXXXXX,  XXXXXXX,            XXXXXXX,            KC_TRNS,
    XXXXXXX,  XXXXXXX,              XXXXXXX,    XXXXXXX,   SGUI(KC_Z),KC_F8,     XXXXXXX,  XXXXXXX,  KC_MUTE,  KC_MPLY,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
...
[_FN4] = LAYOUT_ansi_89(
    XXXXXXX,  XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,    XXXXXXX,   XXXXXXX,   XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            KC_TRNS,
    XXXXXXX,  KC_GRV,     KC_F7,    KC_F8,    KC_F9,    KC_F10,     KC_F11,    KC_F12,    XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            KC_TRNS,
    XXXXXXX,  XXXXXXX,    KC_F13,   KC_F14,   KC_F15,   KC_F16,     KC_P6,     G(C(KC_Q)),LAG(KC_GRV),XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  SGUI(KC_4),         KC_TRNS,
    XXXXXXX,  KC_LCTL,    KC_P1,    KC_P2,    KC_P3,    KC_P4,      KC_P5,     KC_LEFT,   KC_DOWN,    KC_UP,    KC_RGHT,  XXXXXXX,  XXXXXXX,            XXXXXXX,            KC_TRNS,
    XXXXXXX,  KC_LSFT,              XXXXXXX,  KC_P7,    KC_P8,      KC_P9,     KC_P0,     XXXXXXX,    KC_END,   KC_PGDN,  KC_PGUP,  KC_HOME,  XXXXXXX,  XXXXXXX,  XXXXXXX,
