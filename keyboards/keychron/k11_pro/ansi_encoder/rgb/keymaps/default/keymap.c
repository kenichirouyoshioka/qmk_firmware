...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_2] = LAYOUT_69_ansi(
        TO(LAYER_1),     KC_F10,    KC_Z,       KC_P,        TD(TD_P45), TD(TD_P67), TD(TD_P89),KC_7,       KC_8,    KC_9,    KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,          MO(_FN1),
        ...
        MO(_FN2),ALT_T(KC_SLSH),     MT(MOD_LGUI,KC_L),       KC_SPC,     KC_RCTL,              KC_TRNS,             KC_TRNS,           KC_TRNS,            KC_LEFT, KC_DOWN, KC_RGHT),


    [LAYER_3] = LAYOUT_69_ansi(
        KC_ESC,             KC_P1,KC_P2,    KC_P3,   KC_P4,    KC_P5,   KC_P6,      KC_P7,      KC_P8,   KC_P9,   KC_P0,    KC_MINS,  KC_EQL,   KC_BSPC,          TO(LAYER_1),
    ...
    [_FN1] = LAYOUT_69_ansi(
        ...
        TG(LAYER_2),XXXXXXX,    G(KC_N),  G(KC_E), G(KC_COMM),G(KC_T),   XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX,   G(KC_P),  XXXXXXX,   XXXXXXX,  SGUI(KC_4),       XXXXXXX,
