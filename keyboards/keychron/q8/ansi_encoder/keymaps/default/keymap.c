...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_1] = LAYOUT_ansi_69(
                               KC_ESC,     KC_1,     KC_2,     KC_3,    KC_4,    KC_5,    KC_6,       KC_7,        KC_8,    KC_9,    KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,          TG(LAYER_2),
    ...
    [LAYER_2] = LAYOUT_ansi_69(
                               ...
                               MO(_FN2),   ALT_T(KC_SLSH),GUI_T(KC_L),             KC_SPC,                 KC_RCTL,    KC_TRNS,             KC_TRNS,           KC_TRNS,            KC_LEFT, KC_DOWN, KC_RGHT),
