...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_2] = LAYOUT_105_ansi(
        ...
        KC_NUM,   KC_PSLS,  KC_PAST,KC_PMNS,   XXXXXXX,      XXXXXXX,  KC_Z,      KC_P,           TD(TD_P45),  TD(TD_P67),  TD(TD_P89), KC_7,       KC_8,   KC_9, KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,          KC_TRNS,
        ...
        KC_P4,    KC_P5,    KC_P6,             MO(_FN1),     QK_LEAD,  TD(TD_XG), KC_WH_U,        TD(TD_BEA),  KC_ESC,                  KC_H,       KC_J,   KC_K, KC_L,     KC_SCLN,  KC_QUOT,  KC_ENT,           KC_TRNS,
        KC_P1,    KC_P2,    KC_P3,  KC_PENT,   SFT_T(KC_M),            KC_F9,     TD(TD_F1112),   TD(TD_KOH),  TD(TD_VF8),  TD(TD_02),  TO(LAYER_1),KC_N,   KC_M, KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT, KC_UP,
        KC_P0,              KC_PDOT,           MO(_FN2),ALT_T(KC_SLSH),GUI_T(KC_L),               KC_SPC,      MO(_FN4),                            KC_TRNS,      KC_TRNS,  KC_TRNS,            KC_LEFT, KC_DOWN, KC_RGHT),
 ...
 */
    ...
    [_FN1] = LAYOUT_105_ansi(
        ...
        XXXXXXX,   G(KC_N),  G(KC_E),   G(KC_K),   TG(LAYER_2),TG(LAYER_3),G(KC_N),  G(KC_E),  G(KC_COMM),G(KC_T),   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  SGUI(KC_4),         XXXXXXX,
        ...
        XXXXXXX,   G(KC_T),  XXXXXXX,   XXXXXXX,   XXXXXXX,                XXXXXXX,  XXXXXXX,  G(KC_J),   XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_VOLU,
    ...
    [_FN2] = LAYOUT_105_ansi(
        ...
        XXXXXXX,  KC_WH_D,   SGUI(KC_Z),             KC_PENT,    XXXXXXX,  KC_F7,     KC_WH_D,    G(KC_Z),   XXXXXXX,            XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
        XXXXXXX,  XXXXXXX,   G(KC_J),     KC_PENT,   XXXXXXX,              XXXXXXX,   XXXXXXX,    KC_F13,    KC_F14,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
