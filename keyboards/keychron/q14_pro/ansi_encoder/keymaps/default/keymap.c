...
[LAYER_1] = LAYOUT_105_ansi(
    KC_MUTE,  KC_HOME,KC_END,   TG(LAYER_2),   KC_GRV,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   TG(LAYER_4),        MO(_BT),
  TG(LAYER_3),KC_PSLS,KC_PAST,  KC_PMNS,       KC_ESC,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_MUTE,
...
[LAYER_2] = LAYOUT_105_ansi(
  KC_MUTE,  KC_HOME,KC_END,   TO(LAYER_1),   KC_GRV,     KC_F1,         KC_F2,       KC_F3,       KC_F4,       KC_F5,      KC_F6,     KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   TG(LAYER_4),        MO(_BT),
TG(LAYER_3),KC_PSLS,KC_PAST,  KC_PMNS,       KC_ESC,     KC_F10,        KC_Z,        KC_P,        TD(TD_P45),  TD(TD_P67), TD(TD_P89),KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_MUTE,
  KC_P7,    KC_P8,  KC_P9,    KC_PPLS,       TD(TD_TAB1),KC_LBRC,       KC_RBRC,     ALT_T(KC_F1),CTL_T(KC_R), TD(TD_1U),  KC_Y,      KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,            KC_VOLU,
  KC_P4,    KC_P5,  KC_P6,                   MO(_FN1),   QK_LEAD,       TD(TD_XG),   KC_WH_U,     TD(TD_BEA),  KC_ESC,                KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_ENT,             KC_VOLD,
  KC_P1,    KC_P2,  KC_P3,    KC_PENT,       SFT_T(KC_M),               KC_F9,       TD(TD_F1112),TD(TD_KOH),  TD(TD_VF8), TD(TD_02), KC_GRV,   KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,
  KC_P0,            KC_PDOT,                 MO(_FN2),   ALT_T(KC_SLSH),GUI_T(KC_L), KC_SPC,      KC_RCTL,                                      KC_RSFT,            KC_RGUI,  MO(_FN1),           KC_LEFT,  KC_DOWN,  KC_RGHT),
[LAYER_3] = LAYOUT_105_ansi(
  KC_MUTE,  KC_HOME,KC_END,   TG(LAYER_2),   KC_GRV,     KC_F1,       KC_F2,    KC_F3,    KC_F4,    KC_F5,  KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   TG(LAYER_4),        MO(_BT),
TO(LAYER_1),KC_PSLS,KC_PAST,  KC_PMNS,       KC_ESC,     KC_1,        KC_2,     KC_3,     KC_4,     KC_5,   KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_MUTE,
  KC_P7,    KC_P8,  KC_P9,    KC_PPLS,       KC_TAB,     KC_Q,        KC_W,     KC_E,     KC_R,     KC_T,   KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,            KC_VOLU,
  KC_P4,    KC_P5,  KC_P6,                   CTL_T(KC_K),KC_A,        KC_S,     KC_D,     TD(TD_GF),KC_G,             KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_ENT,             KC_VOLD,
  KC_P1,    KC_P2,  KC_P3,    KC_PENT,       SFT_T(KC_Y),             KC_Z,     KC_X,     KC_C,     KC_V,   KC_B,     KC_GRV,   KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,
...
[LAYER_4] = LAYOUT_105_ansi(
    KC_MUTE,  KC_HOME,KC_END,   TG(LAYER_2),   KC_GRV,   KC_F1,      KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   TO(LAYER_1),        MO(_BT),
  TG(LAYER_3),KC_PSLS,KC_PAST,  KC_PMNS,       KC_ESC,   KC_1,       KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_MUTE,
    KC_P7,    KC_P8,  KC_P9,    KC_PPLS,       KC_TAB,   KC_Q,       KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,            KC_VOLU,
    KC_P4,    KC_P5,  KC_P6,                   KC_LCTL,  KC_A,       KC_S,     KC_D,     KC_F,     KC_G,               KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_ENT,             KC_VOLD,
    KC_P1,    KC_P2,  KC_P3,    KC_PENT,       KC_LSFT,              KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_GRV,   KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,
...
[LAYER_5] = LAYOUT_105_ansi(// colemak, right shift
    KC_MUTE,  KC_HOME,KC_END,   TG(LAYER_2),   KC_GRV,   KC_F1,      KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   TO(LAYER_1),        MO(_BT),
  TG(LAYER_3),KC_PSLS,KC_PAST,  KC_PMNS,       KC_ESC,   KC_1,       KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_MUTE,
    KC_P7,    KC_P8,  KC_P9,    KC_PPLS,       KC_TAB,   KC_Q,       KC_W,     KC_F,     KC_P,     KC_G,     KC_J,     KC_L,     KC_U,     KC_Y,     KC_SCLN,  KC_LBRC,  KC_RBRC,  KC_BSLS,            KC_VOLU,
    KC_P4,    KC_P5,  KC_P6,                   KC_LCTL,  KC_A,       KC_R,     KC_S,     KC_T,     KC_D,               KC_H,     KC_N,     KC_E,     KC_I,     KC_O,     KC_QUOT,  KC_ENT,             KC_VOLD,
...
[_FN1] = LAYOUT_105_ansi(
    ...
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  TG(LAYER_2),XXXXXXX,  G(KC_N),  G(KC_E),  G(KC_COMM),G(KC_T),  XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX,  XXXXXXX,   XXXXXXX,  XXXXXXX,            XXXXXXX,
    XXXXXXX,  XXXXXXX,  XXXXXXX,             XXXXXXX,    G(KC_K), G(KC_S),  G(KC_D),  SGUI(KC_Z),G(KC_G),              KC_LEFT,  KC_DOWN,  KC_UP,   KC_RGHT,  XXXXXXX,   XXXXXXX,  XXXXXXX,            XXXXXXX,
...
[_FN2] = LAYOUT_105_ansi(
    ...
    XXXXXXX,  XXXXXXX,  XXXXXXX,             XXXXXXX,  XXXXXXX,  KC_F7,      KC_WH_D,   G(KC_Z),  XXXXXXX,            XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX,  XXXXXXX,   XXXXXXX,  XXXXXXX,            XXXXXXX,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,            XXXXXXX,    XXXXXXX,   KC_F13,   KC_F14,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX,  XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,
    XXXXXXX,            XXXXXXX,             XXXXXXX,  XXXXXXX,  XXXXXXX,    KC_F,     XXXXXXX,                                 XXXXXXX,           XXXXXXX,  XXXXXXX,             XXXXXXX,  XXXXXXX,  XXXXXXX),
[_FN3] = LAYOUT_105_ansi(
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,     XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX,  XXXXXXX,   XXXXXXX,  XXXXXXX,            XXXXXXX,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   KC_P,     KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,       KC_F7,    KC_F8,    KC_F9,   KC_F10,   KC_F11,    KC_F12,   XXXXXXX,            XXXXXXX,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   KC_M,     XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,     XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX,  XXXXXXX,   XXXXXXX,  XXXXXXX,            XXXXXXX,
    XXXXXXX,  XXXXXXX,  XXXXXXX,             KC_ENT,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,               XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX,  XXXXXXX,   XXXXXXX,  XXXXXXX,            XXXXXXX,
