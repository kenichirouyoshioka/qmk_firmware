...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_1] = LAYOUT_ansi_91(
        ...
        MO(_FN4),   MO(_FN1),   KC_LALT,       XXXXXXX,    KC_LGUI,              KC_SPC,                        KC_RSFT,            MO(_FN1), KC_RCTL,   KC_RGUI,  KC_LEFT,   KC_DOWN,    KC_RGHT),
    ...
    [_FN1] = LAYOUT_ansi_91(
        ...
        XXXXXXX,   XXXXXXX,     G(KC_MINS), XXXXXXX,   G(KC_EQL),            KC_BSPC,                          KC_RSFT,            KC_RALT,  KC_RCTL,    KC_RGUI,  KC_MUTE,  KC_VOLD,  KC_MPLY),
