...
[LAYER_1] = LAYOUT_ansi_69(
        ...
        KC_TAB,  KC_Q,     KC_W,     KC_E,    KC_R,    KC_T,    KC_Y,     KC_U,     KC_I,    KC_O,    KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,          TG(LAYER_5),
...
[LAYER_4] = LAYOUT_ansi_69(//hacchan
            KC_ESC,  KC_1,     KC_2,     KC_3,    KC_4,       KC_5,    KC_6,     KC_7,     KC_8,    KC_9,    KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,          KC_TRNS,
            KC_TAB,  KC_Q,     KC_W,     KC_E,    KC_R,       KC_T,    KC_Y,     KC_U,     KC_I,    KC_O,    KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,          KC_TRNS,
            MO(_FN5),KC_A,     KC_G,     KC_WH_U, TD(BEAC),   KC_NO,             KC_H,     KC_J,    KC_K,    KC_L,     KC_SCLN,  KC_QUOT,  KC_ENT,           TO(LAYER_1),
            KC_LSFT,           KC_Z,     KC_X,    KC_C,       KC_V,    KC_B,     KC_GRV,   KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT, KC_UP,
            MO(_FN4),KC_LALT,  KC_LGUI,           KC_SPC,              KC_RCTL,  MO(_FN5),          KC_SPC,            KC_RGUI,            KC_LEFT, KC_DOWN, KC_RGHT),
[LAYER_5] = LAYOUT_ansi_69(// temporally disable keyboard
