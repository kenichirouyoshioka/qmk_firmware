...
[LAYER_1] = LAYOUT_69_ansi(
        ...
        KC_LCTL, KC_A,     KC_S,     KC_D,    KC_F,    KC_G,              KC_H,     KC_J,    KC_K,    KC_L,     KC_SCLN,  KC_QUOT,  KC_ENT,           TG(LAYER_4),
        KC_LSFT,           KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,     KC_GRV,   KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT, KC_UP,
        MO(_FN1),KC_LALT,  KC_LGUI,           KC_SPC,           KC_RCTL,  MO(_FN1),          KC_RSFT,           KC_RGUI,            KC_LEFT, KC_DOWN, KC_RGHT),

[LAYER_2] = LAYOUT_69_ansi(
   TO(LAYER_1), KC_F10,   KC_Z,     KC_P,        TD(TD_P45), TD(TD_P67),TD(TD_P89),KC_7,     KC_8,    KC_9,    KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,          KC_MUTE,
   TD(TD_TAB1),KC_LBRC,   KC_RBRC,  ALT_T(KC_F1),CTL_T(KC_R),TD(TD_1U), KC_Y,      KC_U,     KC_I,    KC_O,    KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,          MO(_BT),
      MO(_FN1),QK_LEAD,   TD(TD_XG),KC_WH_U,     TD(TD_BEA), KC_ESC,               KC_H,     KC_J,    KC_K,    KC_L,     KC_SCLN,  KC_QUOT,  KC_ENT,           TG(LAYER_4),
   SFT_T(KC_M),           KC_F9,    TD(TD_F1112),TD(TD_KOH), TD(TD_VF8),TD(TD_02), KC_GRV,   KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT, KC_UP,
      MO(_FN2),  ALT_T(KC_SLSH),GUI_T(KC_L),     KC_SPC,                KC_RCTL,   MO(_FN1),          KC_RSFT,           KC_RGUI,            KC_LEFT, KC_DOWN, KC_RGHT),

[LAYER_3] = LAYOUT_69_ansi(
        KC_ESC,      KC_1,   KC_2,     KC_3,    KC_4,     KC_5,    KC_6,     KC_7,     KC_8,    KC_9,    KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,          KC_MUTE,
        KC_TAB,      KC_Q,   KC_W,     KC_E,    KC_R,     KC_T,    KC_Y,     KC_U,     KC_I,    KC_O,    KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,          MO(_BT),
        CTL_T(KC_K), KC_A,   KC_S,     KC_D,    TD(TD_GF),KC_G,              KC_H,     KC_J,    KC_K,    KC_L,     KC_SCLN,  KC_QUOT,  KC_ENT,           TG(LAYER_4),
...
[LAYER_5] = LAYOUT_69_ansi(// colemak
            KC_ESC,  KC_1,     KC_2,     KC_3,    KC_4,    KC_5,    KC_6,     KC_7,     KC_8,    KC_9,    KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,          KC_MUTE,
            KC_TAB,  KC_Q,     KC_W,     KC_F,    KC_P,    KC_G,    KC_J,     KC_L,     KC_U,    KC_Y,    KC_SCLN,  KC_LBRC,  KC_RBRC,  KC_BSLS,          MO(_BT),
            KC_LCTL, KC_A,     KC_R,     KC_S,    KC_T,    KC_D,              KC_H,     KC_N,    KC_E,    KC_I,     KC_O,     KC_QUOT,  KC_ENT,           TO(LAYER_1),
            KC_LSFT,           KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,     KC_GRV,   KC_K,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT, KC_UP,
            MO(_FN1),KC_LALT,  KC_LGUI,           KC_SPC,           KC_RCTL,  MO(_FN1),          KC_RSFT,           KC_RGUI,            KC_LEFT, KC_DOWN, KC_RGHT),
...
[_FN2] = LAYOUT_69_ansi(
       ...
       SC,      XXXXXXX,   G(C(KC_F)), SGUI(KC_I),KC_F15,  KC_F16,   XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX,           KC_TRNS,
       KC_PENT, XXXXXXX,   KC_F7,      KC_WH_D,   G(KC_Z), XXXXXXX,            XXXXXXX,  XXXXXXX, XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX,           KC_TRNS,
...
[_FN3] = LAYOUT_69_ansi(
       KC_P,   KC_F1,      KC_F2,    KC_F3,    KC_F4,      KC_F5,     KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_DEL,             KC_TRNS,
       KC_M,   TO(LAYER_1),C(KC_P8), XXXXXXX,  XXXXXXX,    XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            KC_TRNS,
       KC_ENT, C(KC_P4),   C(KC_P2), C(KC_P6), XXXXXXX,    XXXXXXX,             XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_LCTL,            KC_TRNS,
       KC_H,               XXXXXXX,  XXXXXXX,  XXXXXXX,    XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_LSFT,  XXXXXXX,
       XXXXXXX,A(KC_H),    G(KC_I),            KC_SPC,                XXXXXXX,  XXXXXXX,            XXXXXXX,            XXXXXXX,            XXXXXXX,  XXXXXXX,  XXXXXXX),
