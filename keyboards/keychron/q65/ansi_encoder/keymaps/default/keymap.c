...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_1] = LAYOUT_ansi_73(
        KC_MPLY,     KC_ESC,   KC_1,     KC_2,     KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,          KC_MUTE,
    ...
    [LAYER_2] = LAYOUT_ansi_73(
        ...
        G(KC_LBRC),  SFT_T(KC_M),                  KC_F9,    TD(TD_F1112),TD(TD_KOH), TD(TD_VF8), TD(TD_02),  KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_SLSH,            KC_RSFT, KC_UP,   TG(LAYER_3),
    ...
    [LAYER_4] = LAYOUT_ansi_73(// dvorak
        ...
        KC_TRNS,     KC_LSFT,            KC_SCLN,  KC_Q,    KC_J,    KC_K,    KC_X,    KC_B,    KC_M,    KC_W,    KC_V,     KC_Z,               KC_RSFT, KC_UP,   TG(LAYER_5),
        TO(LAYER_1), MO(_FN1), KC_LALT,  KC_LGUI,                             KC_SPC,                             MO(_FN1), KC_RCTL,  KC_RGUI,  KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [LAYER_5] = LAYOUT_ansi_73(//colemak
        ...
        KC_TRNS,     KC_TAB,   KC_Q,     KC_W,     KC_F,    KC_P,    KC_G,    KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN,  KC_LBRC,  KC_RBRC,  KC_BSLS,          KC_TRNS,
        KC_TRNS,     KC_LCTL,  KC_A,     KC_R,     KC_S,    KC_T,    KC_D,    KC_H,    KC_N,    KC_E,    KC_I,    KC_O,     KC_QUOT,            KC_ENT,           KC_TRNS,
        KC_TRNS,     KC_LSFT,            KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,   KC_SLSH,            KC_RSFT, KC_UP,   TG(LAYER_6),
        TO(LAYER_1), MO(_FN1), KC_LALT,  KC_LGUI,                             KC_SPC,                             MO(_FN1), KC_RCTL,  KC_RGUI,  KC_LEFT, KC_DOWN, KC_RGHT),

    [LAYER_6] = LAYOUT_ansi_73(// Kana input
        KC_TRNS,     RO,         NU,       HU,       A,       U,       E,       O,       YA,      YU,      YO,      WA,       HO,       HANDAKU,  KC_BSPC,          KC_TRNS,
        KC_TRNS,     KC_TAB,     TA,       TE,       I,       SU,      KA,      NN,      NA,      NI,      RA,      SE,       DAKUTEN,  MU,       HE,               KC_TRNS,
        KC_ESC,      MO(_FN5),   TI,       TO,       SI,      HA,      KI,      KU,      MA,      NO,      RI,      RE,       KE,                 KC_ENT,           KC_TRNS,
        XXXXXXX,     MO(_FN4),             TU,       SA,      SO,      HI,      KO,      MI,      MO,      NE,      RU,       ME,                 MO(_FN4),KC_UP,   TO(LAYER_1),
        TO(LAYER_1), MO(_FN6),   KC_LALT,  KC_LGUI,                             KC_SPC,                             G(KC_SPC),MO(_FN5), KC_RGUI,  KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [_FN2] = LAYOUT_ansi_73(
        ...
        XXXXXXX,     SC,          G(KC_K),  G(C(KC_F)), SGUI(KC_I), KC_F15,    KC_F16,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,          XXXXXXX,
