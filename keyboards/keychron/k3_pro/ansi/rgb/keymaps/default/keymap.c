...
[LAYER_1] = LAYOUT_ansi_84(
     ...
     KC_LSFT,              KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,             KC_RSFT,    KC_UP,   TG(LAYER_2),
     MO(_FN1),   KC_LALT,  KC_LGUI,                                KC_SPC,                                 KC_RGUI,  MO(_FN1), KC_RCTL,   KC_LEFT,    KC_DOWN, KC_RGHT),
[LAYER_2] = LAYOUT_ansi_84(
     TG(LAYER_3),G(KC_LBRC), G(KC_RBRC), KC_F3,       KC_F4,     KC_F5,    KC_F6,      KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,    KC_TRNS,  KC_TRNS,  KC_TRNS,
     TO(LAYER_1),KC_F10,     KC_LBRC,    KC_RBRC,     KC_P4,     KC_P6,    KC_P8,      KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,    KC_BSPC,            KC_TRNS,
     ...
     KC_LSFT,                MO(_FN4),   TD(TD_F1112),TD(TD_SLH),TD(TD_VL),KC_P0,      KC_F15,   KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,             KC_RSFT,  KC_UP,    TG(LAYER_3),
     MO(_FN2),   KC_LALT,    MT(MOD_LGUI,KC_L),                            KC_SPC,                                   KC_TRNS,  MO(_FN1), KC_TRNS,   KC_LEFT,  KC_DOWN,  KC_RGHT),

[LAYER_3] = LAYOUT_ansi_84(
          TO(LAYER_1), KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,    KC_TRNS,   KC_TRNS,    KC_TRNS,
