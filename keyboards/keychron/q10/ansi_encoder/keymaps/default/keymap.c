...
[LAYER_1] = LAYOUT_ansi_89(
    KC_MPLY,    KC_TILD,    KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,     KC_F6,   KC_F7,      KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_DEL,             KC_MPLY,
...
[LAYER_2] = LAYOUT_ansi_89(
    ...
    G(KC_RBRC), MO(_FN1),   QK_LEAD,        TD(TD_XG),  KC_WH_U,     TD(TD_BEA), KC_ESC,     KC_H,       KC_J,       KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_PENT,            TG(LAYER_3),
...
[LAYER_3] = LAYOUT_ansi_89(
    KC_TRNS,    KC_TRNS,      KC_F1,        KC_F2,      KC_F3,    KC_F4,     KC_F5,     KC_F6,    KC_F7,      KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_DEL,             KC_TRNS,
    ...
    G(KC_I),    CTL_T(KC_K),  KC_A,         KC_S,       KC_D,     TD(TD_GF), KC_G,      KC_H,     KC_J,       KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,             TG(LAYER_4),
...
[LAYER_5] = LAYOUT_ansi_89(//dvorak, right shift
    ...
    KC_HOME,    KC_LCTL,    KC_A,     KC_O,     KC_E,     KC_U,     KC_I,      KC_D,    KC_H,       KC_T,     KC_N,     KC_S,     KC_MINS,            KC_ENT,             TG(LAYER_6),
...
[LAYER_6] = LAYOUT_ansi_89(//colemak, right shift
    XXXXXXX,    KC_GRV,     KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,     KC_F6,   KC_F7,      KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_DEL,             KC_TRNS,
    ...
    KC_HOME,    KC_LCTL,    KC_A,     KC_R,     KC_S,     KC_T,     KC_D,      KC_H,    KC_N,       KC_E,     KC_I,     KC_O,     KC_QUOT,            KC_ENT,             TG(LAYER_7),
...
[LAYER_7] = LAYOUT_ansi_89(// kana input
    ...
    KC_HOME,    MO(_FN1),   TI,       TO,       SI,       HA,       KI,        KU,       MA,         NO,       RI,       RE,       KE,                 KC_ENT,             TO(LAYER_1),
