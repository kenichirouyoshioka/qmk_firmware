...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_F1,       MT(MOD_LGUI,KC_X),TD(TD_VL),    KC_P0,        KC_ESC,    KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_MUTE,
    ...
    QK_LEAD,     G(KC_Z),          KC_ESC,                     KC_LCTL,   KC_A,     KC_S,     KC_D,     KC_F,     KC_G,               KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_ENT,             KC_VOLD,
    ...
    KC_LSFT,                       KC_LCTL,                    MO(_FN1),  KC_LALT,            KC_LGUI,            KC_SPC,   MO(_FN4),           KC_RSFT,            MO(_FN1), QK_LEAD,            KC_LEFT,  KC_DOWN,  KC_RGHT),
...
//colemak
    ...
    [_FN1] = LAYOUT_105_ansi(
        XXXXXXX,   XXXXXXX,   XXXXXXX,  XXXXXXX,   XXXXXXX,    XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
        KC_F6,     KC_F8,     G(KC_N),  G(KC_T),   KC_TILD,    KC_F1,      KC_F2,    KC_F3,    KC_F4,     KC_F5,     KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   XXXXXXX,            XXXXXXX,
        G(KC_K),   KC_WH_D,   G(KC_G),  G(KC_COMM),TG(LAYER_2),TG(LAYER_3),G(KC_W),  G(KC_E),  G(KC_R),   G(KC_T),   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  SGUI(KC_4),         XXXXXXX,
        XXXXXXX,   SGUI(KC_Z),G(KC_E),             XXXXXXX,    G(KC_K),    G(KC_S),  G(KC_D),  SGUI(KC_Z),G(KC_G),             KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
        XXXXXXX,   KC_P1,     KC_P0,    G(KC_D),   XXXXXXX,                G(KC_Z),  G(KC_J),  G(KC_N),   G(KC_COMM),XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_VOLU,
    ...
    [_FN4] = LAYOUT_105_ansi(
        ...
        XXXXXXX,   XXXXXXX,   XXXXXXX,   G(KC_COMM),  KC_LSFT,            XXXXXXX,  KC_LCTL,  KC_F9,     KC_F8,    KC_F7,     XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
