...
[LAYER_2] = LAYOUT_ansi_87(
     ...
     KC_TAB,   TD(CT_GUM),TD(CT_F679),ALT_T(KC_R),KC_F1,     TD(TD_KO),KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,    KC_BSLS, KC_F,      XXXXXXX,   XXXXXXX,
...
[_FN1] = LAYOUT_ansi_87(
     ...
     XXXXXXX,  XXXXXXX,   G(KC_W),  G(KC_E),  G(KC_R),  G(KC_T),  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_END,   KC_MUTE,
    ...
    SGUI(KC_4),           G(KC_Z),  G(KC_X),  G(KC_C),  G(KC_V),  XXXXXXX,  XXXXXXX,  XXXXXXX,  G(KC_COMM),G(KC_DOT),G(KC_SLSH),         KC_MPLY,            KC_VOLU,
     XXXXXXX,  G(KC_MINS),G(KC_EQL),                              KC_BSLS,                                 XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_MUTE,  KC_MPRV,  KC_VOLD,  KC_MNXT),
    
[_FN2] = LAYOUT_ansi_87(
    XXXXXXX,  XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX, XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,  XXXXXXX,  XXXXXXX,
    KC_F11,   KC_7,      KC_8,      KC_9,      KC_0,      KC_F5,     KC_F6,   KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F12,   KC_DEL,    XXXXXXX, XXXXXXX,  XXXXXXX,  XXXXXXX,
    XXXXXXX,  KC_F12,    G(C(KC_F)),SGUI(KC_I),G(KC_COMM),KC_F2,     KC_F3,   KC_F4,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX, XXXXXXX,  XXXXXXX,  XXXXXXX,
