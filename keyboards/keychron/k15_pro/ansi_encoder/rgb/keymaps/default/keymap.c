...
[LAYER_1] = LAYOUT_90_ansi(
         ...
         TG(LAYER_2),KC_LSFT,              KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,    QK_LEAD,    KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,
...
[LAYER_2] = LAYOUT_90_ansi(
        ...
        G(KC_LBRC), KC_LCTL,    KC_LSFT,   KC_LBRC,    KC_RBRC,     KC_P4,      KC_P6,      KC_P8,      KC_7,       KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_TRNS,
        G(KC_RBRC), KC_TAB,     G(KC_J),   TD(TD_MG),  ALT_T(KC_F1),KC_R,       TD(TD_KO),  C(KC_WH_U), KC_F13,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,            KC_TRNS,
        KC_PENT,    MO(_FN1),   QK_LEAD,   TD(TD_XZ),  KC_WH_U,     TD(TD_BEA), KC_ESC,     C(KC_WH_D), KC_F14,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,             KC_TRNS,
        TO(LAYER_1),KC_LSFT,               MO(_FN4),   TD(TD_F1112),TD(TD_SLH), TD(TD_VL),  KC_P0,      QK_LEAD,    KC_F,     KC_F15,   KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,
        KC_LCTL,    MO(_FN2),   KC_LALT,   MT(MOD_LGUI,KC_L),       KC_SPC,     MO(_FN4),                           KC_TRNS,            KC_TRNS,  KC_TRNS,            KC_LEFT,  KC_DOWN,  KC_RGHT),
...
[_FN2] = LAYOUT_90_ansi(
        ...
        XXXXXXX,   KC_PENT,    XXXXXXX,  G(KC_1),    KC_WH_D,   G(KC_Z),   KC_U,      XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,            KC_TRNS,
        XXXXXXX,   XXXXXXX,              XXXXXXX,    XXXXXXX,   KC_P,      KC_F8,     G(KC_0),  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
...
[_FN4] = LAYOUT_90_ansi(
        ...
        XXXXXXX,  XXXXXXX,    KC_F13,   KC_F14,   KC_F15,   KC_F16,     XXXXXXX,   G(C(KC_Q)),LAG(KC_GRV),XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            KC_TRNS,
        XXXXXXX,  KC_LCTL,    XXXXXXX,  KC_F12,   KC_WH_D,  SGUI(KC_Z), KC_F11,    XXXXXXX,   XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,            KC_TRNS,
        XXXXXXX,  KC_LSFT,              XXXXXXX,  KC_LCTL,  KC_F9,      KC_F8,     KC_F7,     XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
