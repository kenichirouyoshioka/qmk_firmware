...
[LAYER_1] = LAYOUT_ansi_89(
    ...
    KC_L,       KC_ESC,     KC_1,     KC_2,     KC_3,     KC_4,     KC_5,      KC_6,    KC_7,       KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_VOLU,
    ...
    KC_P0,      MO(_FN1),   KC_LALT,            KC_LGUI,  KC_SPC,   MO(_FN4),                       KC_RSFT,            MO(_FN1),                     KC_LEFT,  KC_DOWN,  KC_RGHT),
